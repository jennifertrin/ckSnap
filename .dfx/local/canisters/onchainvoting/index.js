...
import { idlFactory } from './onchainvoting.did.js';
export { idlFactory } from './onchainvoting.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REACT_APP_ONCHAINVOTING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./onchainvoting.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the onchainvoting canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./onchainvoting.did.js")._SERVICE>}
 */
export const onchainvoting = createActor(canisterId);
